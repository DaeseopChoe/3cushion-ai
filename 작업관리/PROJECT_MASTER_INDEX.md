...
### 신규 세션 온보딩 (STEP6-4 Rule Catalog Design)

1. **`PROJECT_MASTER_INDEX.md`** (본 문서) — 현재 기능·UI·완료/예정 SSOT  
2. **`CURSOR_SESSION_HANDOFF.md`** — STEP6-4 Entry · Lock · Consume · Pending  
3. **`HISTORY/PROJECT_LOG_2026-07.md`** — STEP6-3 Complete · STEP6-1/2 Freeze Candidate  
4. **`System Platform Standard (SPS) v1.0/STEP6-3_Schema_Rule_Analysis.md`** — **STEP6-3 Complete (v1.1)** · Catalog Design Input  
5. **`System Platform Standard (SPS) v1.0/STEP6_Schema_Validation_Framework.md`** — Framework Freeze Candidate (Locked · Consume)  
6. **`System Platform Standard (SPS) v1.0/STEP6_Validation_Pipeline.md`** — Pipeline Freeze Candidate (Locked · Consume)

### 신규 세션 온보딩 (STEP6-3 Schema Rule Analysis) — 이력 참조

1. **`PROJECT_MASTER_INDEX.md`** (본 문서) — 현재 기능·UI·완료/예정 SSOT  
2. **`CURSOR_SESSION_HANDOFF.md`** — (현행은 STEP6-4 Entry; 이력은 LOG 참고)  
3. **`HISTORY/PROJECT_LOG_2026-07.md`** — STEP6-3 Analysis · v1.1 Reinforcement  
4. **`System Platform Standard (SPS) v1.0/STEP6-3_Schema_Rule_Analysis.md`** — Analysis SSOT (Completed)  
...
| `작업관리/CURSOR_SESSION_HANDOFF.md` | Cursor 세션 이관 메모 (STEP6-4 Entry) |
...
| **SPS Schema Validation (STEP 6)** | **In Progress** — Framework · Pipeline **Freeze Candidate (Locked)** · **STEP6-3 Schema Rule Analysis Complete (v1.1)** · Domain≠Family · Rule Dependency(Cascade) · Next: **STEP6-4 Rule Catalog Design** |
...
> **주의:** Architecture SSOT 확정 이후 실제 코드 이동은 Batch 단위로 진행했다. **AAS Runtime Migration Batch 1~6 Complete (2026-07-13).** **SPS STEP4 Inventory Final v1.0 Complete (2026-07-14).** **SPS STEP5 Architecture Audit Final Freeze v1.0 Complete (2026-07-15).** **SPS STEP6 Framework + Pipeline Freeze Candidate (Locked) Complete (2026-07-15).** **STEP6-3 Schema Rule Analysis Complete (v1.1, 2026-07-17).** 다음: **STEP6-4 Rule Catalog Design**.
...
- **Schema Rule Catalog Design (STEP6-4)** — STEP6-3 v1.1 입력 소비 · Catalog Design · Classification Axis 설계 · Rule Namespace 경로(U1) · **다음 권장**
- **Validation Registers / Report (STEP6-5+)** — Pipeline 절차 소비 · Shape는 후속
- **Validation Engine** — Catalog + Pipeline 이후 (별도 STEP)
...
> **Architecture 상태:** AAS v2.0 **완료**. AAS Runtime Migration Batch 1~6 **Final Freeze**. **SPS STEP4 Inventory Final v1.0 완료.** **SPS STEP5 Architecture Audit Final Freeze v1.0 완료.** **SPS STEP6 Framework + Pipeline = Freeze Candidate (Locked).** **STEP6-3 Schema Rule Analysis Complete (v1.1, 2026-07-17).** 다음 우선순위는 **STEP6-4 Rule Catalog Design**.
...
| **STEP6-3 Analysis** | **Complete (v1.1)** — `STEP6-3_Schema_Rule_Analysis.md` |
| **Architecture** | **Locked** |
| **Framework / Pipeline Review** | **PASS** |
| **Next Phase** | **STEP6-4 Rule Catalog Design** |

Freeze Candidate 이후 Framework / Pipeline 비공식 수정 **금지** (ADR / Review only).  
STEP6-3 Analysis는 Catalog Design **입력 SSOT**로 Consume한다 (본문 재작성·Catalog 혼입 금지).

### 최우선 — Rule Catalog Design (STEP6-4)

- Consume: Framework · Pipeline · **STEP6-3 Analysis v1.1**
- Entry: `CURSOR_SESSION_HANDOFF.md`
- Owner: Schema Validation
- Design: Schema Rule Catalog · Domain≠Family · Dependency metadata · Classification Axis **설계**
- Pending 유지: U1 Namespace · Register · Engine · Coverage 수치식
- **금지:** Framework / Pipeline 수정 · Runtime / System JSON 변경 · Engine 구현
...
| STEP6-4 | Schema Rule Catalog (TBD) | **Next** |
...
| 문서 | 용도 |
|------|------|
| `작업관리/CURSOR_SESSION_HANDOFF.md` | **Cursor 세션 이관** — STEP6-4 Entry · Lock · Consume · Pending |
| `System Platform Standard (SPS) v1.0/STEP6-3_Schema_Rule_Analysis.md` | **STEP6-3 Analysis Complete (v1.1)** — Catalog Design Input |
| `System Platform Standard (SPS) v1.0/STEP6_Schema_Validation_Framework.md` | **STEP6 Framework Freeze Candidate (Locked)** |
...
| `HISTORY/PROJECT_LOG_2026-07.md` | 2026-07 AAS Batch · STEP4 Final · STEP5 Final Freeze · STEP6 Framework+Pipeline · **STEP6-3 Analysis Complete** |
