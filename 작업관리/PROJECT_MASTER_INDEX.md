...
| **AAS Runtime Migration** | **Batch 1 완료 (2026-07-06)** — Domain Layer 초기 분리 완료 · App.jsx 순수 함수 95 lines 제거 · `domain/system/systemIdentity.ts` · `domain/calculator/fiveHalfCalculator.ts` · `domain/calculator/formulaExpr.ts` 생성 · Batch 2 Analysis 대기 |
...
**상태:** **Complete** — Application Runtime Constitution (SSOT) 확정 (2026-07-03) · **Runtime Migration In Progress** — Batch 1 완료 (2026-07-06)
...
> **주의:** Architecture SSOT 확정 이후 실제 코드 이동은 Batch 단위로 별도 진행한다. **Batch 1 완료 (2026-07-06).**
...
| Batch 2 | 낮음 | APP-013, RND-002/004, TRJ-002, OVL-001~008 | Analysis 대기 |
| Batch 3 | 중간 | SRCH-001~005, DS-001~007, CAL-004/006, AI-001~003 | 미착수 |
| Batch 4 | 높음 | CAL-002/003/005, MISC-004 | 미착수 |
...
- **AAS Runtime Migration Batch 2** — Renderer Helper · Overlay Helper · Display/Label Helper · Inline Overlay Component 분리 (Analysis 대기)
...
> **Architecture 상태:** Application Architecture Standard (AAS) v2.0 **완료**. **AAS Runtime Migration 진행 중 — Batch 1 완료 (2026-07-06).** 다음 우선순위는 Batch 2 Analysis.

### 최우선 — AAS Runtime Migration Batch 2

- Batch 1 완료. 다음은 **Batch 2 Analysis** 착수.
- 대상: APP-013(라벨 배율), RND-002/004(시스템 그리드·앵커 변환), TRJ-002(display cap), OVL-001~003/005~008(Overlay 인라인 컴포넌트 분리)
...
### P0 — AAS Runtime Migration (현재 진행)
