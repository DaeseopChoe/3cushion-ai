...
### 신규 세션 온보딩 (Runtime Migration / Batch 6)

1. **`PROJECT_MASTER_INDEX.md`** (본 문서) — 현재 기능·UI·완료/예정 SSOT  
2. **`작업관리/Runtime Refactoring/SESSION_HANDOFF_BATCH5.md`** — Batch 5 Closed · Batch 6 Handoff  
3. **`HISTORY/PROJECT_LOG_2026-07.md`** — Batch 5 Closure 로그 (2026-07-08)
...
| **AAS Runtime Migration** | **Batch 5 완료 (2026-07-08)** — Trajectory Runtime Domain 이전 · App.jsx 5,640 → ~3,903 lines · `domain/trajectory/` · Application Flows · Renderer models · AD-B5-01~11 · Release Gate PASS · **Batch 5 Closed · Release Approved** · **Batch 6 Ready** |
...
**상태:** **Complete** — Application Runtime Constitution (SSOT) 확정 (2026-07-03) · **Runtime Migration In Progress** — Batch 1 완료 (2026-07-06) · **Batch 2 완료 (2026-07-06)** · **Batch 3 완료 (2026-07-07)** · **Batch 4 완료 (2026-07-07)** · **Batch 5 완료 (2026-07-08) — Batch 6 Ready**
...
> **주의:** Architecture SSOT 확정 이후 실제 코드 이동은 Batch 단위로 별도 진행한다. **Batch 1~5 완료 (2026-07-08). 다음: Batch 6 (Runtime Contract / Registry).**
...
| Batch 6 | 최고 | SYS-001/002/003/006, DS-006, Runtime Contract | **Ready — Design 착수 가능** |
...
- **AAS Runtime Migration Batch 6** — Runtime Contract / Registry · D-005/D-006/D-009 해소 · **Design 착수 가능 (Batch 6 Ready)**
...
> **Architecture 상태:** Application Architecture Standard (AAS) v2.0 **완료**. **AAS Runtime Migration 진행 중 — Batch 1~5 완료 (2026-07-08).** 다음 우선순위는 **Batch 6 (Runtime Contract / Registry)**.

### 최우선 — AAS Runtime Migration Batch 6

- Batch 5 완료 (2026-07-08). **Batch 6 Design 착수 가능.**
- 대상: Runtime Contract · Registry · D-005/D-006/D-009 해소
- Batch 5 Baseline: `04e341b` (STEP 5-8 application integration)
- Handoff: `작업관리/Runtime Refactoring/SESSION_HANDOFF_BATCH5.md`
- **Batch5_Design.md 수정 금지** (Frozen)
