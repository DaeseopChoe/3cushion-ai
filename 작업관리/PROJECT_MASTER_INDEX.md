...
2. **`CURSOR_SESSION_HANDOFF.md`** — (현행은 STEP6-6 Entry; 이력은 LOG 참고)  
...
- **Validation Engine Design (STEP6-6)** — Catalog · Register · Pipeline Consume · Engine Design · **다음 권장**
- **Validation Report / Freeze (STEP6-7+)** — 후속
...
> **Architecture 상태:** AAS v2.0 **완료**. Batch 1~6 **Final Freeze**. STEP4/5 **Final Freeze**. STEP6 Framework+Pipeline **Locked**. STEP6-3 **Complete (v1.1)**. STEP6-4 **Complete (v0.2)**. STEP6-5 **Complete (v0.2)**. 다음 우선순위는 **STEP6-6 Validation Engine Design**.
...
| **Architecture** | **Locked** |
| **Next Phase** | **STEP6-6 Validation Engine Design** |

Framework / Pipeline 비공식 수정 **금지**. STEP6-3/4/5는 Engine Design **Consume** 입력.

### 최우선 — Validation Engine Design (STEP6-6)
...
- Design: Engine orchestration under pins · Cascade/Skip recording · Header compatibility check
- **금지:** Framework/Pipeline 수정 · Runtime/System JSON 변경 · 본 STEP에서 실행 구현(별도 명시 없으면 Design Only)
...
| STEP6-6 | Validation Engine Design (TBD) | **Next** |
...
| 문서 | 용도 |
|------|------|
| `작업관리/CURSOR_SESSION_HANDOFF.md` | **Cursor 세션 이관** — STEP6-6 Entry · Lock · Consume · Pending |
