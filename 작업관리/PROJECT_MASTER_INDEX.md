...
| **AAS Runtime Migration** | **Batch 4 완료 (2026-07-07)** — Calculation Runtime Domain 이전 · App.jsx 5,807 → 5,640 lines (−167) · `domain/calculator/systemValueCalculator.ts` · `domain/system/slotSysViewModel.ts` · AD-B4-01 적용 · D-008 Closed · D-006/D-007 Open · **Batch 5 Ready** |
...
**상태:** **Complete** — Application Runtime Constitution (SSOT) 확정 (2026-07-03) · **Runtime Migration In Progress** — Batch 1 완료 (2026-07-06) · **Batch 2 완료 (2026-07-06)** · **Batch 3 완료 (2026-07-07)** · **Batch 4 완료 (2026-07-07) — Batch 5 Ready**
...
> **주의:** Architecture SSOT 확정 이후 실제 코드 이동은 Batch 단위로 별도 진행한다. **Batch 1 완료 (2026-07-06). Batch 2 완료 (2026-07-06). Batch 3 완료 (2026-07-07). Batch 4 완료 (2026-07-07). 다음: Batch 5.**
...
| **Batch 5** | 매우 높음 | TRJ-001/003, RND-003, APP-009 | **Ready — Design 착수 가능** |
...
- **AAS Runtime Migration Batch 4** — Calculation Runtime Domain 이전 완료 (2026-07-07):
  ...
  - ✔ Migration Debt D-008 Closed · Batch 4 Baseline 확정 · Batch 5 Ready
...
- **AAS Runtime Migration Batch 5** — TRJ-001/003, RND-003, APP-009 — Trajectory Runtime · **Design 착수 가능 (Batch 5 Ready)**
...
> **Architecture 상태:** Application Architecture Standard (AAS) v2.0 **완료**. **AAS Runtime Migration 진행 중 — Batch 1 완료 (2026-07-06) · Batch 2 완료 (2026-07-06) · Batch 3 완료 (2026-07-07) · Batch 4 완료 (2026-07-07).** 다음 우선순위는 **Batch 5 Design**.

### 최우선 — AAS Runtime Migration Batch 5

- Batch 4 완료 (2026-07-07). **Batch 5 Design 착수 가능.**
- 대상: TRJ-001/003, RND-003, APP-009 — Trajectory Runtime (최고위험)
- Batch 4 Baseline: `02dd47f` (STEP 4-4 resolveSlotSys ViewModel extraction)
- 실제 코드 이동은 `App_Migration_Map.md` Batch 순서(1→6)와 Part D Review Checklist를 기준으로 수행한다.

### P0 — AAS Runtime Migration Batch 5 (Design 착수)
