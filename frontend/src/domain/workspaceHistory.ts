...
export type SaveWorkspaceHistoryResult =
  | { ok: true }
  | { ok: false; reason: string };

/** workspace_history 저장 */
export function saveWorkspaceHistory(history: WorkspaceSnapshot[]): SaveWorkspaceHistoryResult {
  try {
    if (typeof localStorage === "undefined") {
      return { ok: false, reason: "localStorage is undefined" };
    }
